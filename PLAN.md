# Universal Sambat SDK — 15-Phase Cross-Platform Expansion Plan
...
| 15 | Ecosystem (CDN, CLI, Docs) | npx create-universal-sambat CLI, cdn.config.js, build-types | ✅ COMPLETE |
...
### Goal
Publish `@universal-sambat-sdk/react` as a proper npm package.
...
- `packages/flutter/lib/universal_sambat_sdk.dart`
...
### WordPress
- Plugin file: `universal-sambat-sdk.php`
...
### Laravel
- Composer package: `kushalkhadka/universal-sambat-sdk`
...
### Deliverables
- npm publish all packages under `@universal-sambat-sdk/*`
- jsDelivr + unpkg CDN URLs
- `npx create-universal-sambat` CLI — scaffold by stack (react/vue/angular/etc)
...
```
packages/
├── react/           @universal-sambat-sdk/react
├── vue/             @universal-sambat-sdk/vue
├── angular/         @universal-sambat-sdk/angular
├── svelte/          @universal-sambat-sdk/svelte
├── web-components/  @universal-sambat-sdk/web-components
├── node/            @universal-sambat-sdk/node
├── react-native/    @universal-sambat-sdk/react-native
├── flutter/         universal_sambat_sdk (pub.dev)
├── ios-swift/       NepaliDatePicker (SPM)
├── android-kotlin/  dev.kushalkhadka:universal-sambat-sdk
├── wordpress/       WP plugin
├── laravel/         kushalkhadka/universal-sambat-sdk
├── python/          universal-sambat-sdk (PyPI)
└── cli/             create-universal-sambat (npx)
```
