...
This guide documents the implementation strategy to integrate **Nepali DatePicker Studio** across major web, mobile, and backend technologies: **React, Node.js, Angular, Vue, Svelte, iOS (Swift), Android (Kotlin), React Native, and Flutter**.
...
import 'nepali-datepicker-studio/dist/nepali-datepicker.css';
  ...
  const htmlContent = `
    ...
    <html>
      <head>
        ...
        <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/nepali-datepicker-studio/dist/nepali-datepicker.css">
        <script src="https://cdn.jsdelivr.net/npm/nepali-datepicker-studio/dist/nepali-datepicker.js"></script>
      </head>
...
const { AD2BS, BS2AD } = require('nepali-datepicker-studio');
