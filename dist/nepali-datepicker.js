...
(function (root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    var lib = factory();
    root.NepaliDatePicker = lib.NepaliDatePicker;
    root.NepaliConverterWidget = lib.NepaliConverterWidget;
    root.AD2BS = lib.AD2BS;
    root.BS2AD = lib.BS2AD;
    root.Get2DigitNo = lib.Get2DigitNo;
    root.ConvertToUnicode = lib.ConvertToUnicode;
    root.ConvertToNumber = lib.ConvertToNumber;
    root.NumberToWords = lib.NumberToWords;
    root.NumberToWordsUnicode = lib.NumberToWordsUnicode;
    root.ParseDate = lib.ParseDate;
    root.ConvertToDateObject = lib.ConvertToDateObject;
  }
...
(function (global) {
  ...
  return {
    NepaliDatePicker: window.NepaliDatePicker,
    NepaliConverterWidget: window.NepaliConverterWidget,
    AD2BS: window.AD2BS,
    BS2AD: window.BS2AD,
    Get2DigitNo: window.Get2DigitNo,
    ConvertToUnicode: window.ConvertToUnicode,
    ConvertToNumber: window.ConvertToNumber,
    NumberToWords: window.NumberToWords,
    NumberToWordsUnicode: window.NumberToWordsUnicode,
    ParseDate: window.ParseDate,
    ConvertToDateObject: window.ConvertToDateObject
  };
}));
