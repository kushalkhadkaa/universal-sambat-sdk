...
## Install
```bash
npm install @universal-sambat-sdk/node
```

## Plain Node.js
```js
const { BS2AD, AD2BS, bsToAd, adToBs, todayBs, isValidBs } = require('@universal-sambat-sdk/node');
...
const { nepaliDateParser, validateBsField, autoConvertBsFields } = require('@universal-sambat-sdk/node');
...
fastify.register(require('@universal-sambat-sdk/node').fastifyPlugin, { autoConvert: true });
...
const { BS2AD } = require('@universal-sambat-sdk/node');
