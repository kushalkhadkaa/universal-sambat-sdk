# Nepali DatePicker Studio — Python Package
...
```bash
pip install nepali-datepicker-studio

# With Django support
pip install "nepali-datepicker-studio[django]"

# With Flask
pip install "nepali-datepicker-studio[flask]"

# With FastAPI + Pydantic
pip install "nepali-datepicker-studio[fastapi]"

# Everything
pip install "nepali-datepicker-studio[all]"
```
